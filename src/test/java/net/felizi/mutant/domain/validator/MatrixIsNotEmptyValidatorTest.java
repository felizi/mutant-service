...
public class MatrixIsNotEmptyValidatorTest {
  private @Autowired MatrixIsNotEmptyValidator validator;
  ...
  @Test
  public void shouldTrueWhenSpecialDNA() throws Exception {
    Assert.assertTrue(validator.predicate().test(specialCharDNA));
  }
  ...
  @Test
  public void shouldTrueWhenIcorrectDNA() throws Exception {
    Assert.assertTrue(validator.predicate().test(incorrectDNA));
  }
